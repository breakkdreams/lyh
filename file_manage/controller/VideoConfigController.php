 ...
 * 会员基本配置控制器
 */
class VideoConfigController extends PluginAdminBaseController
{
	//图片上传配置
	public function config()
	{
		...
		return $this->fetch('/fileConfig/video_index');
	}
	...
	public function editSetting(){
		...
		saveModuleConfigData('file_manage','config','video_config.json',$module_info);
		$this->success("修改成功");
	}
